...
## Current Status — v27.1.34 (July 2026)
...
- **Proofs**: 170 Coq files, 1,431 theorems/lemmas. 643 per-rule soundness (637 faithful, 20 conservative, 3 conditional). 0 admits, 0 axioms. ML: `v2_span_extractor_sound` QED.
- **Validators**: 644 rule IDs / 660 spec. 167 fix-producing rules (Bucket A) + 52 Bucket-C candidate rules. 19 L3 file-based + 12 expl3 rules.
...
- **Proof strategy**: 0 admits, 0 axioms; 170 Coq files, 1,431 theorems/lemmas.
...
- 167 auto-fix producers + 52 Bucket-C candidate rules (every fixable rule has an auto-fix or a `--list-candidate-fixes` candidate)
