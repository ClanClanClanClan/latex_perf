...
- **Proofs**: 142 Coq files, 1,133 theorems/lemmas. 638 per-rule soundness (631 faithful, 20 conservative, 3 conditional). 0 admits, 0 axioms. ML: `v2_span_extractor_sound` QED.
...
- 654 rules specified / 638 shipped
