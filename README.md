...
## Current Status — v27.1.44 (July 2026)
...
- **Validators**: 644 rule IDs / 660 spec. 167 fix-producing rules (Bucket A) + 80 Bucket-C candidate rules. 19 L3 file-based + 12 expl3 rules.
