...
**Status**: v26.2.1 released. 644 validators implemented, 1,257 theorems across 159 Coq files (0 admits, 0 axioms), ML v2 byte classifier trained (F1=0.9799, proved). Compile-guarantee contract + byte-lossless CST + rewrite engine + per-rule fix producers live.
