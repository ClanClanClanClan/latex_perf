...
- **Validators**: 596 unique rule IDs / 623 spec (95.7%). 329 golden corpus tests across 12 YAML suites. ~7,350 test cases across 58 suites. LaTeX .log parser for compile-log-dependent rules.
