...
## Current Status — v27.1.38 (July 2026)
...
- **Proofs**: 170 Coq files, 1,450 theorems/lemmas. 643 per-rule soundness (637 faithful, 20 conservative, 3 conditional). 0 admits, 0 axioms. ML: `v2_span_extractor_sound` QED.
...
- **Proof strategy**: 0 admits, 0 axioms; 170 Coq files, 1,450 theorems/lemmas.
