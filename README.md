...
## Current Status — v27.1.33 (July 2026)
...
- **Validators**: 644 rule IDs / 660 spec. 167 fix-producing rules (Bucket A) + 47 Bucket-C candidate rules. 19 L3 file-based + 12 expl3 rules.
...
- 167 auto-fix producers + 47 Bucket-C candidate rules (every fixable rule has an auto-fix or a `--list-candidate-fixes` candidate)
