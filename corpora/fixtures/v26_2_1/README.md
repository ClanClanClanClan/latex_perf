...
| `struct_001_with_bom.tex` | STRUCT-001 + UTF-8 BOM at byte 0 | 1 insert edit at offset **3** (after BOM). Output starts with the BOM unchanged, then `\documentclass{article}\n`, then the original body. v26.3 §3 item A made the producer BOM-aware. |
