...
let rotl64 x r = Int64.(logor (shift_left x r) (shift_right_logical x (64 - r)))
...
let get32_le (b : bytes) off =
  ...
  logor (c 0)
    (logor
       (shift_left (c 1) 8)
       (logor (shift_left (c 2) 16) (shift_left (c 3) 24)))
       ...
       (logor
          ...
          (logor
             ...
             (logor
                ...
                (logor
                   (shift_left (c 5) 40)
                   (logor (shift_left (c 6) 48) (shift_left (c 7) 56)))))))
  ...
  let h0, start =
    if len >= 32 then (
      ...
      let h =
        Int64.(
          logxor
            (logxor (logxor (rotl64 !v1 1) (rotl64 !v2 7)) (rotl64 !v3 12))
            (rotl64 !v4 18))
      in
