...
def gate_generated_authenticity(repo: Path) -> list[str]:
    ...
    # OPEN-082/083. This call is what the docstring above has always promised
    # and the body never did: project_facts.yaml was regenerated by nothing in
    # CI, went 97 commits stale (63/178/1543 against a measured 64/179/1592),
    # and check_repo_facts.py meanwhile pinned ten outward-facing files to the
