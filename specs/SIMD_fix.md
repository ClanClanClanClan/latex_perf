Dylan — here is a copy‑paste–ready fix pack that brings your service in line with SIMD_v2.md:
...
Targets: P99.9 ≤ 20 ms; hedge fired < 1 %; worker rotations < 0.5 % of requests.
