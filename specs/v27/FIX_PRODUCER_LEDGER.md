...
|--------|-------------|-------|---------|-----------|
| **A**  | Mechanical, safe everywhere       | 458 | 61 | 397 |
...
|------|--------|--------|------------|--------|
| `AR-002` | AR | **A** | tentative | pending |
| `BIB-001` | BIB | **C** | tentative | pending |
| `BIB-002` | BIB | **C** | tentative | pending |
...
| `BIB-008` | BIB | **C** | tentative | pending |
...
| `CHAR-005` | CHAR | **A** | tentative | pending |
| `CHAR-006` | CHAR | **A** | confirmed | shipped in v27.0.37 |
| `CHAR-007` | CHAR | **A** | tentative | pending |
| `CHAR-008` | CHAR | **A** | tentative | pending |
| `CHAR-009` | CHAR | **A** | tentative | pending |
| `CHAR-010` | CHAR | **A** | tentative | pending |
| `CHAR-011` | CHAR | **A** | tentative | pending |
| `CHAR-012` | CHAR | **A** | tentative | pending |
| `CHAR-013` | CHAR | **A** | tentative | pending |
| `CHAR-014` | CHAR | **A** | tentative | pending |
...
| `CHEM-004` | CHEM | **A** | tentative | pending |
| `CHEM-005` | CHEM | **A** | tentative | pending |
| `CHEM-006` | CHEM | **A** | tentative | pending |
| `CHEM-007` | CHEM | **A** | tentative | pending |
| `CHEM-008` | CHEM | **A** | tentative | pending |
| `CHEM-009` | CHEM | **A** | tentative | pending |
| `CHEM-010` | CHEM | **A** | tentative | pending |
| `CJK-001` | CJK | **A** | tentative | pending |
| `CJK-002` | CJK | **A** | tentative | pending |
...
| `CJK-008` | CJK | **A** | tentative | pending |
| `CJK-009` | CJK | **A** | tentative | pending |
| `CJK-010` | CJK | **A** | tentative | pending |
| `CJK-011` | CJK | **A** | tentative | pending |
| `CJK-012` | CJK | **A** | tentative | pending |
| `CJK-013` | CJK | **A** | tentative | pending |
| `CJK-014` | CJK | **A** | tentative | pending |
| `CJK-015` | CJK | **A** | tentative | pending |
...
| `CS-001` | CS | **A** | tentative | pending |
| `CS-002` | CS | **A** | tentative | pending |
| `CY-001` | CY | **A** | tentative | pending |
...
| `FR-007` | FR | **A** | tentative | pending |
| `FR-008` | FR | **A** | tentative | pending |
| `HE-001` | HE | **A** | tentative | pending |
| `HI-001` | HI | **A** | tentative | pending |
| `IB-001` | IB | **A** | tentative | pending |
| `JA-001` | JA | **A** | tentative | pending |
| `JA-002` | JA | **A** | tentative | pending |
...
| `MATH-009` | MATH | **A** | tentative | pending |
| `MATH-010` | MATH | **A** | tentative | pending |
| `MATH-011` | MATH | **A** | tentative | pending |
| `MATH-012` | MATH | **A** | tentative | pending |
| `MATH-013` | MATH | **A** | tentative | pending |
| `MATH-014` | MATH | **A** | tentative | pending |
| `MATH-015` | MATH | **A** | tentative | pending |
...
| `MATH-053` | MATH | **A** | tentative | pending |
...
| `MATH-061` | MATH | **A** | tentative | pending |
...
| `MATH-072` | MATH | **A** | tentative | pending |
...
| `MATH-106` | MATH | **A** | tentative | pending |
| `MATH-107` | MATH | **A** | tentative | pending |
| `MATH-108` | MATH | **A** | tentative | pending |
...
| `PKG-002` | PKG | **A** | tentative | pending |
...
| `PKG-007` | PKG | **A** | tentative | pending |
...
| `SCRIPT-005` | SCRIPT | **A** | tentative | pending |
| `SCRIPT-006` | SCRIPT | **A** | tentative | pending |
...
| `SCRIPT-016` | SCRIPT | **A** | tentative | pending |
...
| `SPC-016` | SPC | **A** | tentative | pending |
| `SPC-017` | SPC | **A** | tentative | pending |
| `SPC-018` | SPC | **A** | tentative | pending |
| `SPC-019` | SPC | **A** | tentative | pending |
| `SPC-020` | SPC | **A** | tentative | pending |
| `SPC-021` | SPC | **A** | tentative | pending |
| `SPC-022` | SPC | **A** | tentative | pending |
| `SPC-023` | SPC | **A** | tentative | pending |
| `SPC-024` | SPC | **A** | tentative | pending |
| `SPC-025` | SPC | **A** | tentative | pending |
| `SPC-026` | SPC | **A** | tentative | pending |
| `SPC-027` | SPC | **A** | tentative | pending |
| `SPC-028` | SPC | **A** | tentative | pending |
| `SPC-029` | SPC | **A** | tentative | pending |
| `SPC-030` | SPC | **A** | tentative | pending |
...
| `STYLE-033` | STYLE | **B** | tentative | pending |
...
| `TIKZ-007` | TIKZ | **A** | tentative | pending |
...
| `TYPO-055` | TYPO | **A** | tentative | pending |
| `TYPO-056` | TYPO | **A** | tentative | pending |
| `TYPO-057` | TYPO | **A** | tentative | pending |
