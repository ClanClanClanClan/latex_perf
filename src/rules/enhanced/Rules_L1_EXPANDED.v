...
Module Rule_CMD_001.
  ...
  (* Pattern matching for this rule *)
  Definition pattern : option regex := Some (regex_from_string "\\[a-zA-Z]+").
...
Module Rule_MATH_015.
  ...
  (* Pattern matching for this rule *)
  Definition pattern : option regex := Some (regex_from_string "\\stackrel\{[^}]*\}\{[^}]*\}").
...
Module Rule_MATH_040.
  ...
  (* Pattern matching for this rule *)
  Definition pattern : option regex := Some (regex_from_string "\\ldots").
...
Module Rule_MATH_085.
  ...
  (* Pattern matching for this rule *)
  Definition pattern : option regex := Some (regex_from_string "\\eqcirc").
