...
Module Rule_CJK_006.
  ...
  (* Pattern matching for this rule *)
  Definition pattern : option regex := Some (regex_from_string "\\usepackage(\[[^\]]*\])?\{[^}]+\}").
...
Module Rule_COL_006.
  ...
  (* Pattern matching for this rule *)
  Definition pattern : option regex := Some (regex_from_string "\\color\{[^}]*\}").
...
Module Rule_FIG_001.
  ...
  (* Pattern matching for this rule *)
  Definition pattern : option regex := Some (regex_from_string "\\includegraphics(\[[^\]]*\])?\{[^}]+\}").
...
Module Rule_FIG_003.
  ...
  (* Pattern matching for this rule *)
  Definition pattern : option regex := Some (regex_from_string "\\begin\{figure\}.*?\\end\{figure\}").
...
Module Rule_FIG_012.
  ...
  (* Pattern matching for this rule *)
  Definition pattern : option regex := Some (regex_from_string "\\label\{[^}]+\}").
...
Module Rule_FONT_007.
  ...
  (* Pattern matching for this rule *)
  Definition pattern : option regex := Some (regex_from_string "\\eqalign\{").
...
Module Rule_MATH_023.
  ...
  (* Pattern matching for this rule *)
  Definition pattern : option regex := Some (regex_from_string "\\begin\{equation\}.*?\\end\{equation\}").
...
Module Rule_MATH_028.
  ...
  (* Pattern matching for this rule *)
  Definition pattern : option regex := Some (regex_from_string "\\begin\{eqnarray\*?\}.*?\\end\{eqnarray\*?\}").
...
Module Rule_TAB_001.
  ...
  (* Pattern matching for this rule *)
  Definition pattern : option regex := Some (regex_from_string "\\begin\{table\}.*?\\end\{table\}").
